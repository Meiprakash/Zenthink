    ...
    <div className="bg-gray-100">
      ...
      <div className="min-h-screen px-6 md:px-20 py-16">
        <div className="grid grid-cols-2 p-4 lg:p-8 lg:mb-4 gap-8">
          <h1 className="text-3xl lg:text-4xl ml-7 text-black font-semibold mb-4 col-span-1">
            {blog.title}
          </h1>
          <p className="text-gray-500 mb-8  col-span-1 lg:ml-19 lg:mr-7">
            {blog.content}
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <Image
            ...
            width={1000}
            height={500}
            className="w-full max-w-6xl mx-8 max-h-[500px] object-cover rounded-3xl lg:mb-8 sm:mb-3"
          />
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-3 lg:grid-cols-3 lg:ml-25 gap-8 px-6 md:px-20 pb-16 text-black">
        <div className="lg:col-span-2 sm:col-span-2 space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">Here’s why that’s a problem:</p>
            <ol className="list-decimal list-inside space-y-1 text-black font-semibold">
          ...
          <div>
            <h3 className="text-xl font-medium mb-2">Final Thought</h3>
            <p className="text-gray-700">
        ...
        <div className="col-span-1">
          <div className="px-5 py-3 ">
            <h1 className="text-2xl">Top Authors</h1>
          </div>
          <div className="grid grid-cols-3 ">
            ...
            <div className="col-span-2 lg:mr-30 sm:ml-3">
              ...
              <p className="text-gray-700 sm:text-sm lg:mt-5">Web developer</p>
      ...
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="flex  md:flex-row md:items-end justify-between mb-16 gap-6">
          {/* Left side title */}
          <div>
            <h2 className="text-4xl md:text-5xl sm:text-2xl sm:ml-5 sm:mt-3 font-bold text-gray-900 leading-tight">
              Related Blog
            </h2>
          </div>
