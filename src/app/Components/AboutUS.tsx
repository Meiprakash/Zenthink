...
//     //       </span>
//     //     </p>
//     //     <div className="flex items-center gap-30 md:gap-70">
...
//     //             {/* Right arrow icon (rotates on open) */}
//     //             <span
...
//         {/* Title and Description aligned in two columns */}
...
//           {/* Left: Video Thumbnail */}
//           <div className="flex justify-center md:justify-start w-full h-100">
