...
//         transition={{ duration: 1, ease: "easeOut" }}
//         viewport={{ once: true }}
//         className="absolute left-[-8%] top-[45%] -translate-y-1/2 w-[380px] h-[380px] sm:w-[420px] sm:h-[420px] rotate-[-12deg]"
//       >
//         <Image
//           src="/hero-shape.jpg"
//           alt="Sphere Left"
...
//         transition={{ duration: 1, ease: "easeOut" }}
//         viewport={{ once: true }}
//         className="absolute right-[-8%] bottom-[-4%] w-[380px] h-[380px] sm:w-[420px] sm:h-[420px] rotate-[12deg]"
//       >
//         <Image
//           src="/hero-shape.jpg"
//           alt="Sphere Right"
