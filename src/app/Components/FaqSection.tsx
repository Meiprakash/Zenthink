...
//       {/* Header Section */}
//       <div className="max-w-6xl mx-auto grid grid-cols-1 gap-6 text-center lg:text-left">
//         <div>
//           <p className="flex item-center  text-lg text-black  mb-2 tracking-wide">
//             FAQ{" "}
//             <span>
//               <img src="/badge.jpg" className="w-5 gap-3 ml-2 mt-1" alt="" />
//             </span>
//           </p>
//           <div className="flex items-center ">
//             <h2 className="text-3xl sm:text-4xl font-bold mb-4 leading-tight text-gray-900 mr-5">
...
//       {/* FAQ Grid Section */}
//       <div className="max-w-6xl mx-auto mt-3 grid grid-cols-1 lg:grid-cols-2 gap-1 items-center">
//         {/* Image Section */}
...
//               width={400}
//               height={400}
//               className="rounded-[25px] w-full h-110 object-cover"
//             />
...
//                 together!
//               </p>
//               <button className="bg-black text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-gray-800 transition">
//                 See All Work
//               </button>
//             </div>
//           </div>
    ...
    <section className="w-full bg-white py-0 px-4 sm:px-6 lg:px-10 overflow-hidden">
      ...
      >
        <p className="flex justify-center lg:justify-start items-center text-lg text-black mb-2 tracking-wide">
          FAQ{" "}
          <span>
            <img src="/badge.jpg" className="w-5 ml-2 mt-1" alt="badge" />
          </span>
        </p>
