        ...
        <div className="max-w-[1300px] mx-auto px-6 md:px-1 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-12 md:gap-5">
            ...
            >
              ...
              <Image
                ...
                width={1600}
                height={900}
                className="w-auto max-w-[540px] -ml-2 h-auto mx-auto"
              />
          ...
          >
            <div className="flex  flex-row justify-between items-center sm:gap-4 gap-4 text-left text-sm">
              <div>
                <p className="text-[11px] sm:text-base md:text-md font-normal">
                  All Rights Reserved.
                </p>

                <p className="text-[11px] md:text-[15px] mt-1">
                  Designed by <span className="font-semibold text-[17px]">Zenthink</span>{" "}
                  <span className="px-3">|</span> Powered by <span className="font-semibold text-[17px]">Zenthink</span>
                </p>
              </div>
...
//             <p className="text-neutral-400 mt-2 text-base max-w-sm leading-relaxed">
...
//             <ul className="space-y-5 text-neutral-400 text-lg">
//               {companies.map((item, i) => (
//                 <li key={i}>
//                   <Link
//                     href={item.link}
...
//         {/* BOTTOM ROW */}
//         <div className="flex flex-col sm:flex-row justify-between items-center text-neutral-400 text-sm gap-5">
