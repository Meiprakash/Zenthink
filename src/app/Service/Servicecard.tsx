...
function Servicecard() {
  return (
    <div>
      {/* <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 md:mx-39 sm:mx-7 mx-5 h-full  ">
        {servicecard.map((i, index) => (
          <div
            key={index}
            className="col-span-4 bg-white p-5 rounded-xl shadow-xs hover:shadow-xl transition delay-100 duration-150"
          >
            <div className="mb-18">
              <Image
                src={i.icon}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 md:mx-39 sm:mx-7 mx-5 h-full">
        {servicecard.map((i, index) => {
          const colSpanClass = index < 3 ? "col-span-4" : "col-span-6";

          return (
            <div
              key={index}
              className={`${colSpanClass} bg-white p-5 rounded-xl shadow-xs hover:shadow-xl transition delay-100 duration-150`}
            >
              <div className="mb-18">
                <Image
                  src={i.icon}
              ...
              <div className="mt-6 flex justify-end">
                <Link href={i.link} className="text-black   py-1 p-2 rounded-2xl w-fit flex gap-1">
                  Read more{" "}
                  <span>
                    <Image
                      src="/arrow2.png"
