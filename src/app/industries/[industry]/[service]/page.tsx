...
// // ----------------------
// // Mini reusable sections (inside same file)
// // ----------------------

// const BeyondSection = ({ beyond }: any) => {
...
// const CompanySection = ({ company }: any) => {
//   if (!company) return null;

//   return (
//     <section className="w-full py-10 px-4 md:px-12 bg-[#f8fff3]">
//       <div className="max-w-5xl mx-auto">
...
// const DeliverSection = ({ deliver }: any) => {
...
//         <p className="text-neutral-700 text-lg mt-3 mb-8">
//           {deliver.description}
//         </p>

//         <div className="grid sm:grid-cols-2 gap-6">
//           {deliver.features.map((feature: any, idx: number) => (
//             <div key={idx} className="p-5 bg-white border rounded-xl shadow-sm">
...
// const AdvancedSection = ({ advanced }: any) => {
//   if (!advanced) return null;

//   return (
//     <section className="w-full py-12 px-4 md:px-12 bg-[#f7fff0]">
//       <div className="max-w-6xl mx-auto">
//         <h2 className="text-3xl md:text-4xl font-semibold">{advanced.title}</h2>
...
//           {advanced.features.map((item: any, idx: number) => (
//             <div key={idx} className="p-5 bg-white border rounded-xl shadow-sm">
...
// const CardsSection = ({ cards }: any) => {
//   if (!cards) return null;

//   return (
//     <section className="w-full py-12 px-4 md:px-12">
//       <div className="max-w-6xl mx-auto space-y-8">
//         {cards.sections.map((sec: any, idx: number) => (
...
// // ----------------------
// // Type Interfaces (extended to include new sections)
// // ----------------------
...
//   topProducts?: TopProduct[];
//   products?: Product[];
//   beyond?: { bname: string; bdesc: string };
//   company?: { cname: string; cdesc: string };
//   deliver?: {
//     title: string;
//     description: string;
...
//     features: { title: string; description: string }[];
//   };
//   cards?: { sections: { title: string; description: string }[] };
// }
...
//   const selectedIndustry = industriesData.find(
//     (i: any) => i.slug.toLowerCase() === String(industry).toLowerCase()
//   );

//   const selectedService: Service | undefined = selectedIndustry?.services.find(
//     (s: any) => s.slug.toLowerCase() === String(service).toLowerCase()
//   );
...
//                     />
//                     <Image
//                       src={selectedService.banner || "/placeholder-product.png"}
//                       alt={selectedService.name || selectedService.slug}
//                       fill
//                       className="object-contain relative z-10"
//                       priority
//                       sizes="(max-width: 640px) 250px, (max-width: 768px) 280px, (max-width: 1024px) 350px, (max-width: 1280px) 400px, 450px"
...
//                       Discover solutions crafted with precision and expertise.
//                       Elevate your business with technology designed to
//                       innovate, optimize, and scale.
//                     </p>
//                   </div>
//                 </div>
//               </motion.div>
...
//           {/* -------------------
//               NEW SECTIONS (Inserted here): beyond, company, deliver, advanced, cards
//               ------------------- */}
//           <BeyondSection beyond={selectedService.beyond} />

//           {/* company is optional (first service has it) */}
//           <CompanySection company={(selectedService as any).company} />

//           <DeliverSection deliver={(selectedService as any).deliver} />

//           <AdvancedSection advanced={(selectedService as any).advanced} />

//           <CardsSection cards={(selectedService as any).cards} />
...
//                     services using innovation, efficiency and powerful digital
//                     intelligence.
//                   </p>
//                 </div>
//               </motion.div>
...
//                 {(selectedService.topProducts || []).map(
...
//                   Discover our range of innovative solutions, designed to
//                   optimize, automate, and transform your business operations.
//                 </p>
//               </motion.div>
...
//                           {product.desc ||
//                             "A comprehensive solution designed for modern businesses."}
//                         </p>
