...
export default function AdvancedSection({ advanced }: AdvancedProps) {
  if (!advanced) return null;

  return (
    <section className="w-full py-16 px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-28 bg-[#f9fff5]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {advanced.features.map((item, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 rounded-2xl border border-neutral-200 shadow-sm bg-white"
            >
