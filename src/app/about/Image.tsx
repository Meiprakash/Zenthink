...
export default function SecondComp() {
  ...
  return (
    <div className="relative w-full mx-auto  md:mb-16 px-4 sm:px-6 lg:px-10">
      {/* ===== Hero Image Section ===== */}
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}
        className="relative w-full h-[250px] sm:h-[350px] md:h-[500px] overflow-hidden rounded-2xl shadow-sm"
      >
        <Image
