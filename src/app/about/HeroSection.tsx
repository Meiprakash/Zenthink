...
//         >
//           You Focus on Business <span className="text-neutral-500">We</span>{" "}
//           Power <span className="text-neutral-500">the Technology.</span>
//         </motion.h1>
...
//           "
//         >
//           <div className=" flex  sm:ml-20 sm:mt-10">
//             <Image
//               src="/aboutus.png"
//               alt="award"
//               width={80}
...
const HeroSection = () => {
  return (
    <motion.section
      ...
      className="px-6 sm:px-10 md:px-16 py-12 md:py-20"
    >
      <div
        className="
          max-w-7xl mx-auto
          grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2
          grid-rows-auto md:grid-rows-2
          gap-8 md:gap-12
          items-start
        "
      >
  ...
  "
        >
          <Image
            ...
            width={420}
            height={420}
            className="w-[340px] lg:w-[420px] object-contain rounded-2xl "
            priority
          />
        </motion.div>
      </div>
