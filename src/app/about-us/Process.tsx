...
//   return (
//     <section className="px-6 md:px-16 lg:px-24 py-20 bg-neutral-50">
...
//         <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 max-w-lg leading-snug">
//           Creative Steps That Deliver Real Results
//         </h2>
//         <p className="text-neutral-600 max-w-lg mt-4 md:mt-0 text-base leading-relaxed">
